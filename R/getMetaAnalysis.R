...
getMeta <- function(Coef, SE, Study, Pval, N, cancer_dat, feature){
...
getForestplotPanCancer <- function(Coef, SE, Study, Pval, N , xlab , label, cancer_dat, feature){

  res <- getMeta(Coef, SE, Study, Pval, N, cancer_dat = FALSE, feature)
  data <- res$input_data
...
getForestplotPerCancer <- function( Coef, SE, Study, Pval, N , feature, cancer_dat, xlab , label){

  res <- getMeta(Coef, SE, Study, Pval, N, cancer_dat = TRUE, feature)
