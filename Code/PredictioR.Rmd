...
```{r gene association os, message=FALSE, fig.width=8, fig.height=4}
...
- example for GSVA and summarize the results
...
- example for weighted mean and summarize the results
...
```{r signature score computation weighted mean, message=FALSE, warning = FALSE, fig.width=9, fig.height=5.5}
...
```{r signature score computation specific, message=FALSE, warning = FALSE, fig.width=9, fig.height=5.5}
...
```{r signature score meta-analysis pan, message=FALSE, warning = FALSE, fig.width=8, fig.height=5}
...
```{r signature score meta-analysis per cancer, message=FALSE, warning = FALSE, fig.width=8, fig.height=9}
