...
## Association of CXCL9 gene with OS for selected dataset Mariathasan__Bladder
...
```{r Fig5, fig.width=8, fig.height=9, fig.cap ="Forest plot (CXCL9): cancer-specific analysis", fig.align= 'center'}
