...
forestplotPanCan(coef = cox_os[cox_os$Gene == "CXCL9", "Coef"], 
                    se = cox_os[cox_os$Gene == "CXCL9", "SE"], 
                    study  = cox_os[cox_os$Gene == "CXCL9", "Study"], 
                    pval = cox_os[cox_os$Gene == "CXCL9", "Pval"], 
                    n = cox_os[cox_os$Gene == "CXCL9", "N"], 
...
forestplotPanCan(coef = cox_pfs[ , "Coef"], 
                 se = cox_pfs[ , "SE"], 
                 study  = cox_pfs[ , "Study"], 
                 pval = cox_pfs[ , "Pval"], 
                 n = cox_pfs[ , "N"], 
...
forestplotPerCan(coef = cox_pfs[ , "Coef"], 
                    se = cox_pfs[ , "SE"], 
                    study  = cox_pfs[ , "Study"], 
                    pval = cox_pfs[ , "Pval"], 
                    n = cox_pfs[ , "N"],
...
forestplotPanCan(coef = geneSig_pfs$Coef, 
                 se = geneSig_pfs$SE, 
                 study  = geneSig_pfs$Study, 
                 pval = geneSig_pfs$Pval, 
                 n = geneSig_pfs$N, 
