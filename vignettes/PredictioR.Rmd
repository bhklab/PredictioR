...
dir <- file.path(app_dir, 'PredictioR', 'data/ICB') ## be updated by data folder
...
signature <- read.csv( file.path(dir_GeneSig, "signature_INFO.csv")) 
...
source(here::here('R', 'getGeneAssociation.R'))
source(here::here('R', 'getGeneSigAssociation.R'))
source(here::here('R', 'getMetaAnalysis.R'))
source(here::here('R', 'getGeneSigScore.R'))
...
GeneSig_list <- list.files(dir_GeneSig)[list.files(dir_GeneSig) != "PredictIO.rda"]

AllGeneSig_os <- lapply(1:5, function(i){ # length(GeneSig_list)
